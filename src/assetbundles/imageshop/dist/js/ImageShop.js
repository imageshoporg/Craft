    ...
    Craft.ImageShopDAMField = Garnish.Base.extend(
        {
            ...
            showPopup: function (ev) {
                ...
                $.ajax({
                    url: Craft.getActionUrl('imageshop-da/picker/get-url'),
                    method: "POST",
                    ...
                    success: function (resp) {
                        if (!resp || !resp.url) {
                            var msg = (resp && resp.error) ? resp.error : Craft.t('imageshop-da', 'Could not open ImageShop picker.');
                    ...
                    error: function (xhr) {
                        var msg = (xhr.responseJSON && xhr.responseJSON.error)
                            ...
                            : Craft.t('imageshop-da', 'Could not open ImageShop picker.');
                        Craft.cp.displayError(msg);
                    }
                });
            },
            ...
            refreshAndStore: function (result, newData) {
                ...
                $.ajax({
                    url: Craft.getActionUrl('imageshop-da/content/refresh-metadata'),
                    method: "POST",
                    data: {
            ...
            updatePreview: function (data) {
                ...
                // update list
                var controllerUrl = Craft.getActionUrl('imageshop-da/content/get-image-list');
